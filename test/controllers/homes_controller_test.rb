...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { description: @home.description, name: @home.name, score: @home.score } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { description: @home.description, name: @home.name, score: @home.score } }
